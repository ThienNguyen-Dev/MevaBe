...
$sotin1trang = 20; // khách hàng muốn
...
if( isset($_GET["trang"]) ){
	...
	$trang = 1;	
			...
			$from = ($trang -1 ) * $sotin1trang;
              $query = 'SELECT * FROM danhmuc2,sanpham WHERE danhmuc2.ID_danhmuc2=sanpham.ID_danhmuc2 and gia > 0 and kiemduyet = 1  limit '.$from.', '.$sotin1trang.'';
...
$x = mysqli_query($conn,'SELECT * FROM danhmuc2,sanpham WHERE danhmuc2.ID_danhmuc2=sanpham.ID_danhmuc2 and gia > 0 and kiemduyet = 1 ');
$tongsotin = mysqli_num_rows($x);
$sotrang = ceil($tongsotin / $sotin1trang);
for($t=1; $t<=$sotrang; $t++){
	echo "<a href='index_user_dmsanpham.php?trang=$t'>Trang $t</a>  ";
}
?>
</div>
