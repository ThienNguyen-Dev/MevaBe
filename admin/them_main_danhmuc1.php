    ...
    <main>
        ...
        <div class="card mb-4">
                ...
                <div class="card-body">
                   ...
                   <form action="themxoasuaadmin/themdanhmuc1.php" method="post" id="form_danhmuc1">
      <figure>Thông tin danh mục</figure>
      <label>Tên danh mục</label>
      <input type="text" name="tendanhmuc1" class="danhmuc1"/>
      <br/>
      <label>Hiển thị trên menu</label>
      <select name="hienthimenu" id="combobox" class="danhmuc1">
        <option class="danhmuc1" value="1">
      ...
      <br/>
      <label>Keywork</label>
      <input type="text" name="Keywork" id="key" class="danhmuc1" onClick="FillBilling(this.form)" readonly="readonly"/>
      <br/>
